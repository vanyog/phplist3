...
class WebblerListing
{
    ...
    public function listingElement($element)
    {
        ...
        <tr>
        <td colspan="%d" bgcolor="#CCCC99"><img height="1" alt="" src="images/transparent.png" width="1"></td>
        </tr>
        <!--greenline end-->
...
class WebblerShader
{
  ...
  //    var shaderImg = getItem(\'shaderimg\'+id);
      ...
      if(shaderDiv.style.display == \'block\') {
        ...
        shaderSpan.innerHTML = \'<span class="shadersmall">' .$GLOBALS['I18N']->get('open').'&nbsp;</span><img alt="" src="images/shaderdown.gif" height="9" width="9">\';
        ...
        shaderSpan.innerHTML = \'<span class="shadersmall">' .$GLOBALS['I18N']->get('close').'&nbsp;</span><img alt="" src="images/shaderup.gif" height="9" width="9">\';
        if (shaderImg)
  ...
  function open_span(number, default_status) {
    if (is_ie4up || is_gecko) {
      ...
      if(default_status == \'block\') {
        span_text = \'<span class="shadersmall">' .$GLOBALS['I18N']->get('close').'&nbsp;</span><img src="images/shaderup.gif" alt="" height="9" width="9">\';
      } else {
        span_text = \'<span class="shadersmall">' .$GLOBALS['I18N']->get('open').'&nbsp;</span><img src="images/shaderdown.gif" alt="" height="9" width="9">\';
      }
  ...
  function title_span(number,default_status,title) {
    if (is_ie4up || is_gecko) {
      ...
      if(default_status == \'none\') {
        title_text = \'<img src="images/expand.gif" alt="" height="9" width="9">  \'+title;
        title_class = "shaderfootertextvisible";
      } else {
        title_text = \'<img src="images/collapse.gif" alt="" height="9" width="9">   \'+title;
...
<table width="98%%" align="center" cellpadding="0" cellspacing="0">');
    ...
    {
        return sprintf('
<a href="javascript:shade(%d);" style="text-decoration:none;">&nbsp;<img id="shaderimg%d" src="images/collapse.gif" alt="" height="9" width="9">
    ', $this->num, $this->num);
    }
  ...
  <tr>
    ...
    public function dividerRow()
    {
        return '
  <tr>
      <td colspan="4" class="shaderdivider"><img src="images/transparent.png" height="1" alt="" width="1" /></td>
  </tr>
    ';
    }
  ...
  <tr>
    <td class="shaderborder"><img src="images/transparent.png" alt="" height="1" width="1" /></td>
...
' .$this->dividerRow().'
    ...
    public function contentDiv()
    {
        $html = sprintf('
  <tr>
      <td class="shaderdivider"><img src="images/transparent.png" alt="" height="1" width="1" /></td>
      <td colspan="2">
