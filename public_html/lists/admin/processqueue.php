...
if ($pqChoice == 'local') {
  ...
  <div class="panel">
    ...
    echo '<a href="#" id="stopqueue" class="button">'.snbr(s('stop processing')).'</a>';
    echo '<a href="./?page=processqueue" id="resumequeue" class="button hidden">'.snbr(s('resume processing')).'</a>';
